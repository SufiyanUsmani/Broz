  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: theme === "light" ? "#d9d9d9" : "#000" }}>
      ...
      <View style={{ alignItems: "center" }}>
        ...
        <TextInput style={styles.Input} placeholder='Enter Your phone Number' placeholderTextColor={"#000"} value={phone} onChangeText={(text) => setPhone(text)} />
        <TouchableOpacity style={[styles.Touchable, styles.JACenter]} onPress={handleRegister}>
          <Text style={styles.WhiteF16B}>Next</Text>
        </TouchableOpacity>
        <Text style={{ color: theme === "light" ? "#000" : "#d9d9d9", }}>By entering your number your're agreeing to our</Text>
